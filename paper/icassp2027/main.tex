...
on an Apple M4 Max and an NVIDIA RTX 5080.  On host-specific held-out sets of
...
held-out error reaches 108.2\% versus 18.7\% on the M4 Max.  GGUF structure
...
\begin{figure*}[!t]
  ...
  57 M4 Max and 42 RTX observations, with 81 training and 18 held-out; dashed
...
The first host is an Apple M4 Max with 64~GB unified memory and 12 benchmark
threads; its device-copy bandwidth and FP16 matrix calibration are
...
\midrule
M4 Max & train (15) & 33.6 & 15.8 & \textbf{10.4} & 6.8 & \textbf{4.1}\\
...
On the M4 Max, B2 achieves 10.4\% train and 13.1\% test MAPE; on RTX, it
